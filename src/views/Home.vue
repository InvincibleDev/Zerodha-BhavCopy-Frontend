        ...
        >
          ...
          <b-col>
            <div class="problem-statement">
              <h5 style="color: lawngreen; font-weight: bold">
                About the Toolhsdsdskdk:
              </h5>
              <p style="font-size: medium">
                This tool downloads the BhavCopy data from BSEIndia website
                everyday at 6 PM IST, and presents it in an understanble manner,
                allowing you to search for a specific scrip and export the same
                into CSV.
              </p>
            </div>
          </b-col>
